...
System.register("threefieldscene", [], function() {
  ...
  ($traceurRuntime.createClass)(ThreefieldScene, {
    ...
    rendering: function() {
      ...
      this.updateHUD();
      PXUtil.debug_board('delta: ' + Math.floor(delta * 100000) / 100000 + '<br>' + '<br>person x:' + Math.floor(this.playerController.object.position.x * 100000) / 100000 + " y:" + Math.floor(this.playerController.object.position.y * 100000) / 100000 + " z:" + Math.floor(this.playerController.object.position.z * 100000) / 100000 + '<br>' + 'info.memory.programs:' + this.renderer.info.memory.programs + '<br>' + 'info.memory.geometries:' + this.renderer.info.memory.geometries + '<br>' + 'info.memory.textures:' + this.renderer.info.memory.textures + '<br>' + 'info.render.calls:' + this.renderer.info.render.calls + '<br>' + 'info.render.vertices:' + this.renderer.info.render.vertices + '<br>' + 'info.render.faces:' + this.renderer.info.render.faces + '<br>' + 'info.render.points:' + this.renderer.info.render.points);
      this.renderer.render(this.scene, this.camera);
    },
    loadObjects: function() {
      var $__14 = this;
